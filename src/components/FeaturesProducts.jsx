...
//         icon={
//           <img src={percentageSquare} alt="Discount Icon" className="w-4 h-4" />
//         }
//       />
//       <BadgeCard
//         title={"free return"}
...
//         icon={<img src={Vector1} alt="Discount Icon" className="w-4 h-4" />}
//       />
//       <BadgeCard
//         title={"Payment"}
...
//         icon={<img src={DollarIcon} alt="Dollar Icon" className="w-4 h-4" />}
//       />
//       <BadgeCard
//         title={"100% safe"}
